      ...
      timeline
        ...
        .add(
          scaleCenterImage(
            ...
            centerImageRef.current, screenWidth
          )
        );
  }, [timeline]);
  ...
  return (
    ...
    <section className="fixed top-0 left-0 w-full min-h-full z-2">
      <div className="flex items-center justify-center">
        ...
        <div
          className="block absolute top-1/2 left-1/2  text-white text-center -translate-x-1/2 -translate-y-1/2 z-10 text-3xl sm:text-2xl leading-[1.1 cursor-pointer"
          onClick={() => timeline.play()}
        >
